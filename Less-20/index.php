...
function check_input($con, $value) {
    if (!empty($value)) {
        $value = substr($value, 0, 20); // Truncate to 20 characters
    }
...
if (!isset($_COOKIE['uname'])) {
    ...
    echo "<div align='center' style='margin:20px 0px 0px 510px; background-color:#0CF; text-align:center;width:400px; height:150px;'>";
